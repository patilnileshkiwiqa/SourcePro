...
import com.SourcePro.Materials.ItemMasterBasicDetailEntry.ItemMasterBasicDetailEntryIndexPage;
import com.SourcePro.Materials.ItemMasterBasicDetailEntry.ItemMasterBasicDetailEntryVerification;
import com.SourcePro.Purchase.POMaintenanceNew.POMaintenanceNewIndexPage;
import com.SourcePro.Purchase.POMaintenanceNew.POMaintenanceNewVerification;
...
public class SeleniumInit{
    ...
    protected ItemMasterBasicDetailEntryIndexPage itemMasterBasicDetailEntryIndexPage;
    protected ItemMasterBasicDetailEntryVerification itemMasterBasicDetailEntryVerification;
    
    protected POMaintenanceNewIndexPage pOMaintenanceNewIndexPage;
    protected POMaintenanceNewVerification pOMaintenanceNewVerification;
...
//			chromeOptions.addArguments("--headless");
	...
	public void setUp(Method method, ITestContext testContext,ITestResult testResult) throws IOException, InterruptedException 
	{
	    ...
	    itemMasterBasicDetailEntryIndexPage = new ItemMasterBasicDetailEntryIndexPage(driver); 
	    itemMasterBasicDetailEntryVerification = new ItemMasterBasicDetailEntryVerification(driver); 
	    
	    pOMaintenanceNewIndexPage = new POMaintenanceNewIndexPage(driver);  
	    pOMaintenanceNewVerification = new POMaintenanceNewVerification(driver);  
